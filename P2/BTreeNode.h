...
class BTLeafNode {
  public:
    ...
    */
    ...
    void print();
    void rec_print(string space, PageId pid);
  ...
  private:
    ...
    */
    ...
    static const int MAX_NUM_ENTRY = 
        (PageFile::PAGE_SIZE - sizeof(PageId)) / sizeof(LeafNodeEntry);
}; 
...
class BTNonLeafNode {
  ...
  private:
    ...
    */
    char buffer[PageFile::PAGE_SIZE];
    static const int MAX_NUM_ENTRY = 
        (PageFile::PAGE_SIZE - sizeof(PageId)) / sizeof(NonLeafNodeEntry);
}; 
